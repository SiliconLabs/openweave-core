...
#OPENTHREAD_OUTPUT_DIR = $(OPENTHREAD_ROOT)/output
...
OPENTHREAD_PLATFORM_HEADERS = \
    $(OPENTHREAD_ROOT)/examples/platforms/$(OPENTHREAD_TARGET)/openthread-core-efr32-config.h \
...
OPENTHREAD_DEFINES = \
    ...
    MBEDTLS_USER_CONFIG_FILE='\"efr32-mbedtls-config.h\"' \
    OPENTHREAD_CONFIG_NUM_MESSAGE_BUFFERS=22 \
    $(MCU) 
    
OPENTHREAD_INC_DIRS = \
	  $(PROJECT_ROOT) \
  	$(OPENWEAVE_ROOT)/src/adaptations/device-layer/include/Weave/DeviceLayer/EFR32/crypto \
...
CONFIG_FILE_PATH = $(OPENTHREAD_ROOT)/examples/platforms/$(OPENTHREAD_TARGET)/
...
STD_LIBS += \
    ...
    -lopenthread-efr32mg21 \
    -lmbedcrypto \
    -lsilabs-efr32mg21-sdk
...
STD_LINK_PREREQUISITES += \
    ...
    $(OPENTHREAD_LIB_DIR)/libopenthread-efr32mg21.a \
    $(OPENTHREAD_LIB_DIR)/libmbedcrypto.a \
    $(OPENTHREAD_LIB_DIR)/libsilabs-efr32mg21-sdk.a
