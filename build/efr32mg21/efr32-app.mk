...
STD_INC_DIRS += \
    $(OPENTHREAD_ROOT)/examples/platforms/efr32mg21/                                        \
    $(OPENTHREAD_ROOT)/examples/platforms/efr32mg21/$(shell echo $(BOARD) | tr A-Z a-z)     \
    $(OPENTHREAD_ROOT)/examples/platforms/efr32mg21/crypto                                  \
...
MBEDTLS_FLAGS = \
    ...
    -DMBEDTLS_USER_CONFIG_FILE='"efr32mg21-weave-mbedtls-config.h"'
...
LINKER_SCRIPT = $(realpath $(PROJECT_ROOT))/$(APP)-MG21.ld
endif
