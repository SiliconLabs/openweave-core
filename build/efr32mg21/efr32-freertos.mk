...
$(OUTPUT_DIR)/freertos/port.c.o     : $(FREERTOS_ROOT)/Source/portable/GCC/ARM_CM4F/port.c $(FREERTOSCONFIG_DIR)/FreeRTOSConfig.h
	$(CC) -c  $(STD_CFLAGS) $(CFLAGS) $(DEBUG_FLAGS) $(OPT_FLAGS) $(DEFINE_FLAGS) $(INC_FLAGS) $(FREERTOS_ROOT)/Source/portable/GCC/ARM_CM4F/port.c -o $(OUTPUT_DIR)/freertos/port.c.o
