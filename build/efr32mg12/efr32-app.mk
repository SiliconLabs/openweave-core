...
STD_INC_DIRS += \
    $(OPENTHREAD_ROOT)/examples/platforms/efr32mg12/                                        \
    $(OPENTHREAD_ROOT)/examples/platforms/efr32mg12/$(shell echo $(BOARD) | tr A-Z a-z)     \
    $(OPENTHREAD_ROOT)/examples/platforms/efr32mg12/crypto                                  \
...
MBEDTLS_FLAGS = \
    ...
    -DMBEDTLS_USER_CONFIG_FILE='"efr32mg12-weave-mbedtls-config.h"'
...
LINKER_SCRIPT = $(realpath $(PROJECT_ROOT))/$(APP)-MG12P.ld
endif

LINKER_SCRIPT_INC_DIRS = $(PROJECT_ROOT) $(OUTPUT_DIR)/freertos ~/git/github/openthread/output/efr32/lib
...
define OptionHelp
  BOARD=board           Build image for a particular module. 
                        Supported boards are BRD4161A, BRD4166A, BRD4170A and BRD4304A.
