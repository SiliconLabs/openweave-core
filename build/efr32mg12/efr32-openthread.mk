...
OPENTHREAD_DEFINES = \
    ...
    MBEDTLS_USER_CONFIG_FILE='\"efr32mg12-weave-mbedtls-config.h\"' \
...
STD_LIBS += \
    ...
    -lopenthread-efr32mg12 \
    -lmbedcrypto \
    -lsilabs-efr32mg12-sdk
...
STD_LINK_PREREQUISITES += \
    ...
    $(OPENTHREAD_LIB_DIR)/libopenthread-efr32mg12.a \
    $(OPENTHREAD_LIB_DIR)/libmbedcrypto.a \
    $(OPENTHREAD_LIB_DIR)/libsilabs-efr32mg12-sdk.a
