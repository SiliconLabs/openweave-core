...
public:
    ...
    static constexpr uint8_t kWeaveFactory_KeyBase  = 0xA2; // Persistent config values set at manufacturing time. Retained during factory reset.
    static constexpr uint8_t kWeaveConfig_KeyBase   = 0xA3; // Persistent config values set at runtime. Cleared during factory reset.
    static constexpr uint8_t kWeaveCounter_KeyBase  = 0xA4; // Persistent counter values set at runtime. Retained during factory reset.
    ...
    static constexpr Key kConfigKey_DeviceId                = EFR32ConfigKey(kWeaveFactory_KeyBase, 0x01);
    static constexpr Key kConfigKey_DeviceCert              = EFR32ConfigKey(kWeaveFactory_KeyBase, 0x02);
    static constexpr Key kConfigKey_DevicePrivateKey        = EFR32ConfigKey(kWeaveFactory_KeyBase, 0x03);
    ...
    static constexpr Key kConfigKey_ProductRevision         = EFR32ConfigKey(kWeaveConfig_KeyBase, 0x07);
    static constexpr Key kConfigKey_GroupKeyBase            = EFR32ConfigKey(kWeaveConfig_KeyBase, 0x08);
    static constexpr Key kConfigKey_GroupKeyMax             = EFR32ConfigKey(kWeaveConfig_KeyBase, 0x18); // Allows 16 Group Keys to be created.

    // Set key id limits for each group.
    static constexpr Key kMinConfigKey_WeaveFactory         = EFR32ConfigKey(kWeaveFactory_KeyBase, 0x00);
    static constexpr Key kMaxConfigKey_WeaveFactory         = EFR32ConfigKey(kWeaveFactory_KeyBase, 0x05);
    static constexpr Key kMinConfigKey_WeaveConfig          = EFR32ConfigKey(kWeaveConfig_KeyBase, 0x00);
    static constexpr Key kMaxConfigKey_WeaveConfig          = EFR32ConfigKey(kWeaveConfig_KeyBase, 0x17);
    static constexpr Key kMinConfigKey_WeaveCounter         = EFR32ConfigKey(kWeaveCounter_KeyBase, 0x00);
    static constexpr Key kMaxConfigKey_WeaveCounter         = EFR32ConfigKey(kWeaveCounter_KeyBase, 0x1F); // Allows 32 Counters to be created.
